...
path50_w2ms = os.path.join("/home/test4/code/EventBenchmark/lib/pytracking/data/EventSOT500","50_w2ms")
...
for seq in os.listdir(path50_w2ms):
    seq=os.path.join(path50_w2ms,seq)
    #img deleted
