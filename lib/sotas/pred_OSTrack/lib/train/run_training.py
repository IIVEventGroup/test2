...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 distill=None, script_teacher=None, config_teacher=None, pred_next=0):
...
def main():
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 distill=args.distill, script_teacher=args.script_teacher, config_teacher=args.config_teacher,pred_next=args.pred_next)
